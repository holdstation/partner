...
import { List, TagField, TextField, useTable, UrlField } from "@refinedev/antd";
      ...
      <List title="Deposit List" resource="deposit">
        ...
        >
          ...
          <Table.Column
            ...
            title="TX Hash"
            render={(value: DepositType["transactions"]) => (
          ...
          <Table.Column
            ...
            title="Status"
            render={(_: number, item: DepositType) => (
              <TagField
          ...
          <Table.Column
            ...
            render={(value: DepositType["created_at"]) => (
              <TextField
